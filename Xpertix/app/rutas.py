...
from app.modelos import db, Usuario, Recurso, Proyecto, Tarea, Comentario, RegistroActividad, Feedback
...
def agregar_proyecto():
    ...
    if formulario.validate_on_submit():
        ...
        usuario_id = 1  # Este ID debe existir en la tabla usuarios
        usuario = Usuario.query.get(usuario_id)
        if usuario:
            nueva_actividad = RegistroActividad(
                accion=f'Proyecto "{nuevo_proyecto.titulo}" agregado',
            ...
            flash('Error: El usuario no existe en la base de datos.', 'danger')
